  ...
  Widget build(BuildContext context) {
    ...
    final errorResWidget = error.map(
      ...
      screenNotImplementedError: (_) {
        if (errorWidget != null) {
          errorWidget.children.add(const ScreenNotImplementedErrorWidget());
          return errorWidget;
        } else {
      ...
      unknownError: (_) {
        if (errorWidget != null) {
          errorWidget.children.add(UnknownErrorScreen(callback: callback));
          return errorWidget;
        } else {
          return UnknownErrorScreen(callback: callback);
        }
      },
    );
